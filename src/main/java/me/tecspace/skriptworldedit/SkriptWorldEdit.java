package me.tecspace.skriptworldedit;
...
import me.tecspace.skriptworldedit.api.plugin.UpdateChecker;
...
public class SkriptWorldEdit extends JavaPlugin implements AddonModule {

    private static SkriptWorldEdit instance;
    public static boolean UsesFastAsyncWorldEdit;

    public static SkriptWorldEdit getInstance() {
        return instance;
    }
    ...
    public void onEnable() {
        ...
        SkriptAddon addon = Skript.instance().registerAddon(SkriptWorldEdit.class, "SkriptWorldEdit");
    ...
    public void init(SkriptAddon skriptAddon) {
        ClassLoader.builder()
            .basePackage("me.tecspace.skriptworldedit.types")
            .deep(false)
            .initialize(true)
            .forEachClass(clazz -> {
                try {
    ...
    public void load(SkriptAddon skriptAddon) {
        ClassLoader.builder()
            .basePackage("me.tecspace.skriptworldedit.elements")
            .deep(true)
            .initialize(true)
            .forEachClass(clazz -> {
